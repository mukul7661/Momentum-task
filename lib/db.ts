...
export const configuration = {
  flow: "flow name",
  entities_to_mock: ["ProxyConfig.load_team_config"],
  is_db_mocked: true,
  db_config: {
    username: "user",
    password: "password",
...
export function addIds(node: any) {
  // Generate a unique ID for the current node
  node.id = uuidv4();

  // Recursively add IDs to children if they exist
  if (node.children && Array.isArray(node.children)) {
    node.children.forEach((child: any) => addIds(child));
  }
}
  ...
  children: [
    {
      ...
      params: [
        ...
        { identifier: "team_id", type: "str" },
      ],
      response_object: "",
      children: [
        {
          function: "/litellm/proxy/proxy_server.py:ProxyConfig.get_config",
          params: [{ identifier: "self", type: null }],
          response_object: "dict",
          children: [
            {
              function: "/litellm/proxy/utils.py:update_spend",
              params: [
                { identifier: "prisma_client", type: "PrismaClient" },
                {
                  identifier: "db_writer_client",
                  type: "Optional[HTTPHandler]",
                },
                { identifier: "proxy_logging_obj", type: "ProxyLogging" },
              ],
              response_object: "",
              children: [
                {
                  function: "/litellm/proxy/utils.py:print_verbose",
                  params: [{ identifier: "print_statement", type: null }],
                  response_object: "",
                  children: [],
                },
              ],
    ...
    {
      function: "/litellm/proxy/proxy_server.py:parse_cache_control",
      params: [{ identifier: "cache_control", type: null }],
      response_object: "",
      children: [],
    },
    {
      function: "/litellm/proxy/proxy_server.py:select_data_generator",
      params: [
        { identifier: "response", type: null },
        { identifier: "user_api_key_dict", type: null },
      ],
      response_object: "",
      children: [
        {
          ...
          children: [
            {
              ...
              params: [
                { identifier: "self", type: null },
                { identifier: "original_exception", type: "Exception" },
                { identifier: "user_api_key_dict", type: "UserAPIKeyAuth" },
              ],
              response_object: "",
              children: [
                {
      ...
      children: [
        {
          ...
          params: [
            { identifier: "self", type: null },
            { identifier: "message", type: "str" },
            { identifier: "level", type: 'Literal["Low", "Medium", "High"]' },
            {
              identifier: "alert_type",
              type: 'Literal[\n            "llm_exceptions",\n            "llm_too_slow",\n            "llm_requests_hanging",\n            "budget_alerts",\n            "db_exceptions",\n        ]',
            },
    ...
    {
      function: "/litellm/proxy/utils.py:_read_request_body",
      params: [{ identifier: "request", type: null }],
      response_object: "",
      children: [],
    },
  ],
